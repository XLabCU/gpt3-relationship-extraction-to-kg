...
The code for `python_api.py` is via https://medium.com/geekculture/relationship-extraction-with-gpt-3-bb019dcf41e5 and https://github.com/dgg32/gpt-3-extract.
